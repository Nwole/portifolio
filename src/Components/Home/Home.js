...
import wealth from "../../../src/assets/wealth.jpg";
    ...
    <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900" >
      <section className=" min-h-screen">
        <nav className="py-10 pb-12 flex justify-between">
          <h1 className="text-4xl text-gray-400 font-bold ">Developedbyed </h1>
        ...
        <div className="relative bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 mx-auto overflow-hidden md:w-96 md:h-96">
          <img src={wealth} layout="fill" objectfit="cover" />
        </div>
      </section>
      <section>
        <div>
          ...
          <p className="text-md py-2 loading-8 text-gray-800">
            Since the begining of my journey as a front-end developer, i
            have developed and designed muiltiple perfect user interface for may organizations
